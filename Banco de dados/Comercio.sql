...
CREATE TABLE IF NOT EXISTS `Comercio`.`Pedido` (
  ...
  `tipo_pedido` ENUM('AVISTA','APRAZO_SEM_ENTRADA','APRAZO_COM_ENTRADA') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Comercio`.`Produto` (
  ...
  INDEX `fk_Produto_Fornecedor1_idx` (`fornecedor_produto` ASC),
...
-- -----------------------------------------------------
-- Table `Comercio`.`Conta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Comercio`.`Conta` (
  `codigo_conta` INT NOT NULL AUTO_INCREMENT,
  `situacao_conta` ENUM('A','P') NOT NULL,
...
-- -----------------------------------------------------
-- Table `Comercio`.`Conta_receber`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Comercio`.`Conta_receber` (
  `codigo_conta` INT NOT NULL,
  `pedido_receber` INT NOT NULL,
  INDEX `fk_Conta_receber_Pedido1_idx` (`pedido_receber` ASC),
  INDEX `fk_Conta_receber_Conta1_idx` (`codigo_conta` ASC),
  PRIMARY KEY (`codigo_conta`),
  CONSTRAINT `fk_Conta_receber_Pedido1`
    FOREIGN KEY (`pedido_receber`)
    REFERENCES `Comercio`.`Pedido` (`codigo_pedido`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Conta_receber_Conta1`
    FOREIGN KEY (`codigo_conta`)
    REFERENCES `Comercio`.`Conta` (`codigo_conta`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Comercio`.`Conta_pagar`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Comercio`.`Conta_pagar` (
  `codigo_conta` INT NOT NULL,
  `compra_pagar` INT NOT NULL,
  INDEX `fk_Conta_pagar_Compra1_idx` (`compra_pagar` ASC),
  INDEX `fk_Conta_pagar_Conta1_idx` (`codigo_conta` ASC),
  PRIMARY KEY (`codigo_conta`),
  CONSTRAINT `fk_Conta_pagar_Compra1`
    FOREIGN KEY (`compra_pagar`)
    REFERENCES `Comercio`.`Compra` (`codigo_compra`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Conta_pagar_Conta1`
    FOREIGN KEY (`codigo_conta`)
    REFERENCES `Comercio`.`Conta` (`codigo_conta`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `Comercio`.`Caixa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Comercio`.`Caixa` (
  `codigo_caixa` INT NOT NULL AUTO_INCREMENT,
  `nome_caixa` VARCHAR(50) NOT NULL,
  `status_caixa` ENUM('A','F') NOT NULL,
  `saldo_caixa` DECIMAL(10,2) NOT NULL,
  PRIMARY KEY (`codigo_caixa`),
  UNIQUE INDEX `nome_caixa_UNIQUE` (`nome_caixa` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `Comercio`.`Movimento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Comercio`.`Movimento` (
  `codigo_movimento` INT NOT NULL AUTO_INCREMENT,
  `tipo_movimento` ENUM('E','S') NOT NULL,
  `caixa_movimento` INT NOT NULL,
  `conta_movimento` INT NOT NULL,
  PRIMARY KEY (`codigo_movimento`),
  INDEX `fk_Movimento_Caixa1_idx` (`caixa_movimento` ASC),
  INDEX `fk_Movimento_Conta1_idx` (`conta_movimento` ASC),
  CONSTRAINT `fk_Movimento_Caixa1`
    FOREIGN KEY (`caixa_movimento`)
    REFERENCES `Comercio`.`Caixa` (`codigo_caixa`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Movimento_Conta1`
    FOREIGN KEY (`conta_movimento`)
    REFERENCES `Comercio`.`Conta` (`codigo_conta`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Comercio`.`Operacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Comercio`.`Operacao` (
  `codigo_operacao` INT NOT NULL AUTO_INCREMENT,
  `data_abertura` DATETIME NOT NULL,
  `data_fechamento` DATETIME NULL,
  `saldo_abertura` DECIMAL(10,2) NOT NULL,
  `saldo_fechamento` DECIMAL(10,2) NULL,
  `funcionario_operacao` INT NOT NULL,
  `caixa_operacao` INT NOT NULL,
  PRIMARY KEY (`codigo_operacao`),
  INDEX `fk_Operacao_Funcionario1_idx` (`funcionario_operacao` ASC),
  INDEX `fk_Operacao_Caixa1_idx` (`caixa_operacao` ASC),
  CONSTRAINT `fk_Operacao_Funcionario1`
    FOREIGN KEY (`funcionario_operacao`)
    REFERENCES `Comercio`.`Funcionario` (`codigo_funcionario`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_Operacoes_Caixa1`
    FOREIGN KEY (`caixa_operacao`)
    REFERENCES `Comercio`.`Caixa` (`codigo_caixa`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
